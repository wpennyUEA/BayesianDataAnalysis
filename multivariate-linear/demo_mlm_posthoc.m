...
disp('In this simulation only inputs 1, 2 and 3 are predictive of outputs');
disp('We use an ''input'' prior which shrinks connections from irrelevant inputs to zero');
disp('We also run some post-hoc inference based on Savage-Dickey tests');
disp(' ');
