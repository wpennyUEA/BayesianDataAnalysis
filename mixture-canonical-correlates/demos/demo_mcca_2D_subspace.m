...
grid on
xlabel('c2');
ylabel('prediction, c1hat');

% Compute predictions more efficiently with vectorised input
[c1hat_check,gamma] = vbcca_cond_subspace (cca,c2,con);
figure
plot(c2',c1hat_check,'r-');
grid on
xlabel('c2');
ylabel('prediction, c1hat');
